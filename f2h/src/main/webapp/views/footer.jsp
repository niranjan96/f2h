...
<footer class="w3-padding-64  w3-small w3-center" id="footer">
    <div class="w3-row-padding">
      ...
      <div class="w3-col s4">
        <h4>Store</h4>
        <p><i class="fa fa-fw fa-map-marker"></i> f2h</p>
        <p><i class="fa fa-fw fa-phone"></i> 9688504775</p>
        <p><i class="fa fa-fw fa-envelope"></i> f2h@mail.com</p>
    ...
    <section style="text-align:center; margin:10px auto;"><p>Designed by Gowthman.P</p></section>
